...
class Network():
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        for x, y in mini_batch:
            ...
            n_b = [new_b+dnb for new_b, dnb in zip(n_b, d_n_b)]
            n_w = [new_w+dnw for new_w, dnw in zip(n_w, d_n_w)]
        self.weights = [w-(eta/len(mini_batch))*new_w
                        for w, new_w in zip(self.weights, n_w)]
        self.biases = [b-(eta/len(mini_batch))*new_b
                       for b, new_b in zip(self.biases, n_b)]
